    ...
    <header class="header-area clearfix">
        ...
        <nav class="amado-nav">
            <ul>
                ...
                <li><a href="<%=request.getContextPath()%>/views/user/login.jsp">Login</a></li>
        ...
        <!-- Cart Menu -->
            <div class="cart-fav-search mb-100">
              <a href="<%=request.getContextPath()%>/views/user/cart.jsp" class="cart-nav"><img src="img/core-img/cart.png" alt=""> Cart <span>(0)</span></a>
              <a href="<%=request.getContextPath()%>/views/user/likeproduct.jsp" class="fav-nav"><img src="img/core-img/favorites.png" alt=""> Favourite</a>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-5">
                    <div class="single_product_desc">
                        ...
                        <!-- Add to Cart Form -->
                        <h6>Số Lượng Còn Lại : ${proDetail.quantity}</h6>
...
<%--                            <button name=""  class="btn amado-btn">Add to cart</button>--%>
                                          <a  class="btn amado-btn" href="<%=request.getContextPath()%>/CartServlet?action=addCart&&productID=${proDetail.productID}">Add to cart</a>
                        </form>
