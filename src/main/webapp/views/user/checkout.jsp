    ...
    <header class="header-area clearfix">
        ...
        <nav class="amado-nav">
            <ul>
                ...
                <li><a href="../user/shop.jsp">Shop</a></li>
        ...
        <div class="cart-fav-search mb-100">
            <a href="../user/cart.jsp" class="cart-nav"><img src="<%=request.getContextPath()%>/views/img/core-img/cart.png" alt=""> Cart <span>(0)</span></a>
            <a href="../user/likeproduct.jsp" class="fav-nav"><img src="<%=request.getContextPath()%>/views/img/core-img/favorites.png" alt=""> Favourite</a>
                    ...
                    <div class="cart-summary">
                        ...
                        <div class="payment-method">
                            ...
                            <div class="custom-control custom-checkbox mr-sm-2">
                                ...
                                <label class="custom-control-label" for="paypal">Paypal <img class="ml-15" src="<%=request.getContextPath()%>/views/img/core-img/paypal.png" alt=""></label>
                            </div>
                        </div>
