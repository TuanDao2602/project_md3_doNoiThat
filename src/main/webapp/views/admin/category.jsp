                ...
                <ul class="navbar-nav navbar-align">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="../admin/index.html"><i class="align-middle me-1"
                    ...
                    <div class="card-header">
                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="../views/admin/createCatalog.jsp">
                                    <button type="button" class="btn btn-success">+ Add new Category</button>
                                </a>
                                <form action="<%=request.getContextPath()%>/CatalogServlet">
                                    <input class="form-control me-2 fst-italic" name="searchName" type="search" placeholder="Enter category's name... "
                                           aria-label="Search">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${listCatalog}" var="cat">
                                <tr>
                                    <td>${cat.catagoriesID}</td>
                                    <td>${cat.catagoriesName}</td>
                                    <td>${cat.catagoriesStatus?"Active":"Inactive"}</td>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/CatalogServlet?catagoriesID=${cat.catagoriesID}&&action=Update">Update</a>
                                        <a href="<%=request.getContextPath()%>/CatalogServlet?catagoriesID=${cat.catagoriesID}&&action=Delete">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
