          ...
          <div class="card-header">
            ...
            <nav class="navbar navbar-expand-lg bg-light">
              <div class="container-fluid">
                <a class="navbar-brand" href="<%=request.getContextPath()%>/views/admin/createProduct.jsp">
                  <button style="margin-bottom: 35px" type="button" class="btn btn-success">+ Add new Product</button>
                </a>
                <form action="<%=request.getContextPath()%>/ProductServlet" >
                  <input style="width: 500px;margin-right: 100px;border-radius: 25px" class="form-control me-2 fst-italic" name="searchName"  type="search" placeholder="Enter product's name... "
                         aria-label="Search">
                  <button style="width: 100px;margin-left: 200px" class="btn btn-outline-success" name="action" value="Search" type="submit">Search</button>
                </form>
              </div>
            </nav>
          </div>
            ...
            <table id="example1" class="table table-bordered table-striped text-center">
              ...
              <c:forEach items="${listProduct}" var="pro">
                <tr>
                  ...
                  <td><img style="width: 100px;height: 100px" src="<%=request.getContextPath()%>/images/${pro.productImages}"/></td>
                  <td>${pro.title}</td>
                  <td>${pro.quantity}</td>
                  <td>${pro.price}</td>
                  <td>${pro.productStatus?"Active":"Inactive"}</td>
                  <td>${pro.catagoriesID}</td>
                  <td>
                    <a href="<%=request.getContextPath()%>/ProductServlet?productId=${pro.productID}&&action=detail">Detail</a>
                  </td>
                  <td>
