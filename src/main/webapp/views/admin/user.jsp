            ...
            <nav class="navbar navbar-expand-lg bg-light">
              <div class="container-fluid">
                ...
                <form class="d-flex" role="search">
                  <input class="form-control me-2 fst-italic " name="search"  type="search"
                         placeholder="Enter user's name... "
                         aria-label="Search">
                  <button name="action" value="search" class="btn btn-outline-success" type="submit">Search</button>
                </form>
              </div>
            </nav>
          </div>
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped text-center">
              ...
              <tr>
                ...
                <td>
                  <a href="<%=request.getContextPath()%>/UserServlet?action=unlook&&userId=${User.userId}"><button type="button" class="btn btn-success">Unlock</button></a>
                </td>
                <td>
                  <a href="<%=request.getContextPath()%>/UserServlet?action=look&&userId=${User.userId}"><button type="button" class="btn btn-danger">Lock</button></a>
                </td>
              </tr>
              <tr>
